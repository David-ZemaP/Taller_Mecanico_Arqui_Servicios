...
{
    public class SmtpMailSender : Taller_Mecanico_Users.Application.Services.IMailSender, Taller_Mecanico_Users.Domain.Ports.IMailSender
    {
        private readonly Taller_Mecanico_Users.Application.Services.SmtpSettings _settings;
        private readonly ILogger<SmtpMailSender> _logger;

        public SmtpMailSender(Taller_Mecanico_Users.Application.Services.SmtpSettings settings, ILogger<SmtpMailSender> logger)
        {
            _settings = settings;
            _logger = logger;
        }
