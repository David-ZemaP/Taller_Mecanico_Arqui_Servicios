...
public class ReporteResumenModel : PageModel
{
    ...
    public ReporteResumenModel(OrdenTrabajoAdapter adapter)
    {
        _adapter = adapter;
    }
    ...
    public async Task<IActionResult> OnGetExcelAsync()
    {
        ...
        ws.Cell(2, 1).Value = $"Resumen de Ingresos — Año {Anio}" +
            (string.IsNullOrEmpty(EstadoTrabajo) ? "" : $" — Estado: {EstadoTrabajo}");
